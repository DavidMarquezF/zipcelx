...
const validTypes = [CELL_TYPE_STRING, CELL_TYPE_NUMBER, CELL_TYPE_DATE, CELL_TYPE_TIME, CELL_TYPE_DATETIME];
...
var generatorDateCell = (index, value, rowIndex, dateStyle) => (`<c r="${generatorCellNumber(index, rowIndex)}" s="${dateStyle}"><v>${dateStyle === 1 ? parseInt((value - new Date(1900, 1, 1)) / (24 * 60 * 60 * 1000), 10) : value}</v></c>`);
...
var stylesXML = `<?xml version="1.0" encoding="utf-8"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
<fonts count="1"><font><sz val="11"/><name val="Calibri"/><family val="2"/></font></fonts><fills count="2"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill></fills><borders count="1"><border diagonalDown="0" diagonalUp="0"><left/><right/><top/><bottom/><diagonal/></border></borders><cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" /></cellStyleXfs><cellXfs count="2"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0" applyNumberFormat="1" /><xf numFmtId="14" fontId="0" fillId="0" borderId="0" xfId="0" applyNumberFormat="1" /></cellXfs><cellStyles count="1"><cellStyle xfId="0" builtinId="0" name="Normal"/></cellStyles></styleSheet>`;
